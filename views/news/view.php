    ...
    <body class="gallery-page">
        <div class="wrap-body">
            <header class="">
                <div class="logo">
                    <a href="#">M & M</a>
                    <span><?php echo $newsItem['short_content']; ?></span>
                </div>
                        ...
                        <li class="has-sub"><a href="/news/"><span>Trips</span></a>
                            <ul>
                                <?php foreach ($newsList as $news): ?>
                                    <li class="has-sub"><a href="/news/<?php echo $news['id']; ?>"><span><?php echo $news['title']; ?></span></a>
                                        <ul>
                                            <li><a href="/news/<?php echo $news['id']; ?>"><span><?php echo $news['short_content']; ?></span></a></li>
                                        </ul>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                                ...
                                <article class="single-post zerogrid">
                                    <div class="row wrap-post"><!--Start Box-->
                                        <div class="entry-header">
                                            ...
                                            <h2 class="entry-title"><a><?php echo $newsItem['title']; ?></a></h2>
                                        ...
                                        <div class="entry-content">
                                            ...
                                            <div class="excerpt"><p><?php echo $newsItem['content']; ?></p>
                                            </div>
                                        </div><a href="/news/"><span>BACK TO ALL TRIPS</span></a>
                                    </div>
                                </article>
                            </div>
                        </div>
